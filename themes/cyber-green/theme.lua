...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/cyber-green"
theme.wallpaper = theme.dir .. "/wall.jpg"
theme.font = "Noto Sans Mono 12"
theme.fg_normal = "#23D5D3" -- Main Text 				                    (Cyber Blue)
theme.fg_focus = "#40FF60" -- Highlighted Text			                    (Cyber Green)
...
theme.border_focus = "#40FF60" -- Focused Window Borders		            (Cyber Green)
theme.border_marked = "#FF4A57" -- Marked? Window Borders		            (Cyber Red)
theme.tasklist_fg_focus = "#40FF60" -- Tasklist Foreground Text Color	    (Cyber Green)
