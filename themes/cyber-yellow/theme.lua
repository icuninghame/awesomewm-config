...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/cyber-yellow"
theme.wallpaper = theme.dir .. "/wall.jpg"
theme.font = "Noto Sans Mono 12"
theme.fg_normal = "#23D5D3" -- Main Text 				                    (Cyber Blue)
theme.fg_focus = "#ffe24e" -- Highlighted Text			                    (Cyber Yellow)
...
theme.border_focus = "#ffe24e" -- Focused Window Borders		            (Cyber Yellow)
theme.border_marked = "#FF4A57" -- Marked? Window Borders		            (Cyber Red)
theme.tasklist_fg_focus = "#ffe24e" -- Tasklist Foreground Text Color	    (Cyber Yellow)
