...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/black-cyan"
...
theme.dark = "#0C0C0C"
theme.light = "#3B3C36"
theme.fg_normal = theme.white -- Main Text 				                    (Cyber Blue)
theme.fg_focus = "#23D5D3" -- Highlighted Text			                    (Cyber Pink)
theme.fg_urgent = "#FF4A57" -- Urgent Text				                    (Cyber Red)
theme.bg_normal = theme.black -- Window Unfocused Background		            (Darkest Blue)
theme.bg_focus = theme.dark -- Window Focused Background		                (Darker Blue)
theme.bg_urgent = theme.white -- Window Bright Background		                (Dark Blue)
theme.border_width = dpi(0.5) -- Border with, px scaled w/ dpi
theme.border_normal = theme.light -- Unfocused Window Borders		            (Cyber Blue)
theme.border_focus = "#23D5D3" -- Focused Window Borders		            (Cyber Pink)
theme.border_marked = "#FF4A57" -- Marked? Window Borders		            (Cyber Red)
theme.tasklist_fg_focus = "#23D5D3" -- Tasklist Foreground Text Color	    (Cyber Pink)
theme.tasklist_bg_focus = theme.black -- Tasklist Focused BG Color		(Darkest Blue)
theme.tasklist_bg_normal = theme.black -- Tasklist Normal BG Color		(Darkest Blue)
