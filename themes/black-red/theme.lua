...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/black-red"
...
theme.accent = "#FF4A57"
-- 
theme.fg_normal = theme.white -- Main Text 				                    
theme.fg_focus = theme.accent -- Highlighted Text			                    
theme.fg_urgent = "#FF4A57" -- Urgent Text				                    
theme.bg_normal = theme.black -- Window Unfocused Background		            
theme.bg_focus = theme.dark -- Window Focused Background		                
theme.bg_urgent = theme.white -- Window Bright Background		                
theme.border_width = dpi(0.5) -- Border with, px scaled w/ dpi
theme.border_normal = theme.light -- Unfocused Window Borders		            
theme.border_focus = theme.accent -- Focused Window Borders		            
theme.border_marked = theme.accent -- Marked? Window Borders		           
theme.tasklist_fg_focus = theme.accent -- Tasklist Foreground Text Color	    
theme.tasklist_bg_focus = theme.black -- Tasklist Focused BG Color		
theme.tasklist_bg_normal = theme.black -- Tasklist Normal BG Color		
theme.dmenu_fg_focus = theme.fg_focus -- Dmenu Highlighted Item Txt color	
theme.dmenu_bg_focus = theme.bg_focus -- Dmenu Highlighted Item BG Color	
theme.dmenu_fg_normal = theme.fg_normal -- Dmenu Text Color			        
theme.dmenu_bg_normal = theme.bg_normal -- Dmenu BG Color			        
theme.titlebar_bg_focus = theme.bg_normal -- Titlebar Focused BG Color		
theme.titlebar_bg_normal = theme.bg_normal -- Titlebar Normal BG Color		
theme.titlebar_fg_focus = theme.fg_focus -- Titlebar Focused Txt Color		
theme.bg_systray = theme.bg_focus -- BG Color for Systray			
