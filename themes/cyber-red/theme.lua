--[[
    ...
    author: ijc
    license: free to use under the Cool Kids License

    Palette:
     Darkest Blue:       #000B19
     Darker Blue:        #000B1E
     Dark Blue:          #091833
     Medium Blue:        rgb(9, 69, 114)
     Cyber Blue:         #23D5D3
     Cyber Pink:         #ED1E79
     Cyber Red:          #FF4A57
     Cyber Yellow:       #EBE702
     Cyber Light Yellow: #FFE562
     Cyber Amber:        #F0C674
--]]
...
local theme = {}
theme.dir = os.getenv("HOME") .. "/.config/awesome/themes/cyber-red"
theme.wallpaper = theme.dir .. "/wall.jpg"
theme.font = "Noto Sans Mono 12"
theme.fg_normal = "#23D5D3" -- Main Text 				                    (Cyber Blue)
theme.fg_focus = "#FF4A57" -- Highlighted Text			                    (Cyber Red)
...
theme.border_focus = "#FF4A57" -- Focused Window Borders		            (Cyber Red)
theme.border_marked = "#ED1E79" -- Marked? Window Borders		            (Cyber Pink)
theme.tasklist_fg_focus = "#FF4A57" -- Tasklist Foreground Text Color	    (Cyber Red)
...
theme.dmenu_fg_focus = theme.fg_focus -- Dmenu Highlighted Item Txt color	(Cyber Yellow)
...
theme.layout_tileleft = theme.dir .. "/awesome-icons/align-right.svg"
...
theme.layout_centerwork = theme.dir .. "/awesome-icons/tablet-alt.svg"
